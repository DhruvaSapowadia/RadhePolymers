    ...
    theme: {
        extend: {
            fontSize: {
                ...
                '7xl': ['4.5rem', { lineHeight: '1.0', letterSpacing: '0.002em', fontWeight: '700' }],
                '8xl': ['6rem', { lineHeight: '1.0', letterSpacing: '0.001em', fontWeight: '700' }],
                '9xl': ['8rem', { lineHeight: '1.0', letterSpacing: '0.001em', fontWeight: '700' }],
            },
            fontFamily: {
